          ...
          <ul className="friends-list__list">
              ...
              <div className="thumbnail-friend">
                <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
                  <div className="thumbnail-friend__image-status">
                    <ThumbnailPicture sourceName={'thumbnail-friend__image-status'} imageSrc={'img/content/thumbnails/friend-14'}/>
                  </div>
            ...
            <li className="friends-list__item">
              <div className="thumbnail-friend">
                <div className="thumbnail-friend__info thumbnail-friend__info--theme-light">
                  <div className="thumbnail-friend__image-status">
                    <ThumbnailPicture sourceName={'thumbnail-friend__image-status'} imageSrc={'img/content/thumbnails/friend-13'}/>
                  </div>
                  <div className="thumbnail-friend__header">
